...
const CaravanDetailModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
              ...
              <div className="row">
                ...
                <div className="col-lg-9">
                  <div className="pop-top">
                    <h3>2024 Everest Alpine Freestyle 18′6 Full Off Road Slideouts with Ensuite</h3>
                    <div className="vehicleThumbDetails__part__price pop_up_price">
                      <span>
                        <span className="woocommerce-Price-amount amount">
                          <bdi>
                            <span className="woocommerce-Price-currencySymbol">$</span>89,990
                          </bdi>
                        </span>
                      </span>
                    </div>
