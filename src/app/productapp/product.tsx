          ...
          <div className="row justify-content-center">
            ...
            <div className="col-xl-8 col-lg-8 col-md-12">
              ...
              <div className="product-info left-info">
                <h1 className="title">
                  2022 Aura Allion 19′ Touring 2 Berth with Shower and Toilet
                </h1>
                      ...
                      <div className="content-info text-center pb-0">
                        <div className="additional-info">
                          <ul>
                            ...
                            <li>
                              <strong>Make:</strong> Aura
                            </li>
                            <li>
                              <strong>Year:</strong> 2022
                            </li>
                            <li>
                              <strong>Model:</strong> Allion
                            </li>
                            <li>
                              <strong>Condition:</strong> Used
                            </li>
                            <li>
                              <strong>Length:</strong> 19 ft
                            </li>
                            <li>
                              <strong>Sleep:</strong> 2 people
                            </li>
                            <li>
                              <strong>ATM:</strong> 2705 Kg
                            </li>
                            <li>
                              <strong>Tare Mass:</strong> 2255 Kg
                            </li>
                            <li>
                              <strong>Ball Weight:</strong> 185 Kg
                            </li>
                            <li>
                              <strong>Location:</strong> South Australia
                            </li>
                          </ul>
                        </div>
                      </div>
