          ...
          <div className="filter-accordion-items">
            {locations.map((loc) => (
              <div
                key={loc}
                className="filter-accordion-item"
                onClick={() => console.log("Location:", loc)}
              >
                {loc}
              </div>
            ))}
          ...
          <div className="filter-accordion-items ">
            {conditions.map((cond) => (
              <div
                key={cond}
                className="filter-accordion-item"
                onClick={() => console.log("Condition:", cond)}
              >
                {cond}
              </div>
            ))}
          ...
          <div className="filter-accordion-items ">
            {sleeps.map((sleep) => (
              <div
                key={sleep}
                className="filter-accordion-item"
                onClick={() => console.log("Sleeps:", sleep)}
              >
                {sleep}
              </div>
            ))}
