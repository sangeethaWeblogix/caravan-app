...
const STATES = [
  ...
  'Victoria', 'South Australia', 'Australian Capital Territory', 'Tasmania'
]

const CATEGORIES = [
  'off-road', 'hybrid', 'pop-top', 'luxury', 'family',
  'touring'
]
        ...
        <div className="container">
          <div className="logo_left">
            <Link className="navbar-brand" href="/">
              <Image src="/images/cfs-logo-black.svg" alt="Caravans For Sale" width={150} height={50} />
            </Link>
          </div>
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
              <ul className="navbar-nav mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link className="nav-link" href="/about-our-deals/">About Our Deals</Link>
                </li>
              </ul>
            </div>
          ...
          <ul>
            <li>
              <a
                href="#"
                className="drop_down"
                onClick={(e) => { e.preventDefault(); toggleDropdown('state') }}
              >
                Browse by State
              </a>
              <ul className={openDropdown === 'state' ? 'submenu open' : 'submenu'}>
                {STATES.map(state => (
                  <li key={state}>
                    <Link
                      className="dropdown-item"
                      href={`/listings/${state.toLowerCase().replace(/ /g, '-')}-state/`}
                      onClick={closeNav}
                    >
                      {state}
                    </Link>
            ...
            <li>
              <a
                href="#"
                className="drop_down"
                onClick={(e) => { e.preventDefault(); toggleDropdown('category') }}
              >
                Browse by Category
              </a>
            ...
            <li>
              <a
                href="#"
                className="drop_down"
                onClick={(e) => { e.preventDefault(); toggleDropdown('price') }}
              >
                Browse by Price
              </a>
            ...
            <li><Link href="/listings/" onClick={closeNav}>All Listings</Link></li>
