        ...
        <div className="container">
          <div className="title">
            ...
            <div className="modern_links">
              ...
              <div className="al-ty-bd">
                {[
                  ...
                  [
                    "Newcastle",
                    "new-south-wales-state/newcastle-and-lake-macquarie-region",
                  ],
            ...
            <div className="modern_links">
              <h3>Size</h3>
              <div className="al-ty-bd">
                {Array.from({ length: 17 }, (_, i) => i + 12).map(
                  (size, index) => (
                    <span key={index}>
                      <Link
              ...
              <div className="al-ty-bd">
                {[
                  [
                    ...
                    "/best-caravans-full-off-road-capabilities-australia/",
                  ],
                  [
                  ...
                  [
                    ...
                    "/best-semi-off-road-caravans-australia-guide/",
                  ],
                  [
                    "Best Extreme Off Road Caravans",
                    "/best-caravans-for-extreme-off-road-travel/",
                  ],
                  [
                    "Best Luxury Caravans",
                    "/best-luxury-caravans-australia-highlights-features-reviews/",
                  ],
                  [
                    "Best Family Caravans",
                    "/top-family-off-road-caravans-australia/",
                  ],
